...
OUTPUT_DIR=./log/$Datasets/${Base_model}_b${Per_device_batch_size}_lr${Learning_rate}_${Tasks}_${Epoch}/pretrain2
mkdir -p $OUTPUT_DIR
log_file=$OUTPUT_DIR/pretrain.log

torchrun --nproc_per_node=3 --master_port=2309 pretrain.py \
